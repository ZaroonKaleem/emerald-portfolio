...
const closeModal = () => {
    ...
    <div>
      ...
      <div className="flex container mb-20 gap-20 flex-col mt-10 mg:mt-20">
        {portfolioProjects.map((project, projectIndex) => (
          // <Card
          //   key={project.title}
          //   className="px-8 hover:opacity:40 pt-8 pb-0 md:pt-12 md:px-10 lg:pt-16 lg:px-20 sticky cursor-pointer"
          //   style={{
          //     top: `calc(94px + ${projectIndex * 20}px`,
          //   }}
  ...
  className="px-8 pt-8 pb-0 md:pt-12 md:px-10 lg:pt-16 lg:px-20 sticky cursor-pointer 
             hover:opacity-80 hover:scale-102 hover:shadow-xl transition-all duration-300 ease-in-out"
  style={{
    top: `calc(94px + ${projectIndex * 20}px)`,
  }}
  onClick={() => openModal(project)}
    ...
    >
      ...
      >
        ...
        <ul className="flex flex-col gap-2">
          {selectedProject.results.map((result: any) => (
